...
function goldeneagle_optionsframework_machine($options) {
                    ...
                    if ($select_value != '') {
                        ...
                        if ($value['std'] == $key) {
                            $checked = ' checked';
                                ...
                                $output .= '<input class="of-input of-radio" type="radio" name="' . esc_attr($value['id']) . '" id="' . esc_attr($value['id'].$key) . '" value="' . esc_attr($key) . '" ' . $checked . ' /><label for="' . esc_attr($value['id'].$key) . '">' . esc_html($option) . '</label><br/>';
                }
                    break;
                    case "checkbox":
    ...
    function goldeneagle_optionsframework_uploader_function($id, $std, $mod) {
        ...
        if ($mod != 'min') {
            $val = $std;
            if (goldeneagle_get_option($id) != "") {
                $val = goldeneagle_get_option($id);
            }
